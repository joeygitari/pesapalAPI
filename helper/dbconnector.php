...
class pesapal{
	...
	function getUser($data){
		...
		if(!$user['id']) {
			...
			$sql 		= "INSERT INTO users (`first_name`, `last_name`, `email`,`phone_number`,`account_no`) ". 
			       		  "VALUES ('".$firstName."', '".$lastName."','".$email."','".$phoneNo."','".$accountNo."')";
